        ...
        <nav class="navbar navbar-expand">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-message-list">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{asset('images/avatars/avatar-10.pn')}}g" class="msg-avatar" alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{asset('images/avatars/avatar-11.pn')}}g" class="msg-avatar" alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ Auth::user()->image_url ? asset(Auth::user()->image_url) : Avatar::create(Auth::user()->name)->toBase64()}}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{Auth::user()->name}}</p>    
                        <p class="designattion mb-0">{{Auth::user()->get_role->name}}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{route('show_profile.userController',Auth::user()->id)}}"><i class="bx bx-user"></i><span>Show Profile</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{route('logout.index')}}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>

<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <a href="{{route('dashboard.index')}}"><img src="{{asset('images/logo-icon.png')}}" class="logo-icon" alt="logo icon"></a>
        </div>
        <div>
            <a href="{{route('dashboard.index')}}"><h4 class="logo-text">Rocker</h4></a>
        </div>

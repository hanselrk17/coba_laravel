                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            ...
                            <a href="{{ route('tambah_item_web.itemController') }}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Item</a>
                        </div>
                    </div>
